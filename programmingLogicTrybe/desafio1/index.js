// Desafio #1 Conversor Fahrenheit-Celsius
/* 
  Para se converter uma temperatura medida em um termômetro em Fahrenheits
  para a escala Celsius, com a qual estamos mais acostumados no Brasil
  deve-se usar a equação C = (F-32)/1.8, onde C é a temperatura em graus
  Celsius e F a temperatura medida em Fahrenheits.
  ...
  Por exemplo ao receber a leitura de 95ºF retorne 35.0ºC
*/
...
function fahrenheit_to_celsius(temp_fahrenheit) {
  ...
  const temp_celsius = ((temp_fahrenheit - 32) / 1.8).toFixed(1);
  return temp_celsius;
}